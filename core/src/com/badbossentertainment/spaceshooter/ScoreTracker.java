...
public class ScoreTracker {
    ...
    public static final int FONT_SCALE = 3;
    ...
    public void render(ShapeRenderer sr, Batch batch, BitmapFont font) {
        ...
        font.draw(batch, "Score: " + getTotalPoints() + "", 0, 0);
        batch.end();
        ...
        font.draw(batch, "Killed: " + enemiesKilled, 0, 0);
        batch.end();
        ...
        font.draw(batch, "Stars: " + starsCollected, 0, 0);
        batch.end();
