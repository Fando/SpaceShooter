    ...
    public class Star extends Visual {
        ...
        public void render(ShapeRenderer sr, SpriteBatch batch) {
            ...
            if (super.getY() < -super.getHeight()) {
                super.setY(Gdx.graphics.getHeight() + super.getWidth());
                super.setX(MathUtils.random(0, Gdx.graphics.getWidth() - super.getWidth()));
            }

            sr.rect(super.getX(), super.getY(), super.getWidth(), super.getHeight());
            //sr.circle(super.x, super.y, super.width);
        }
    }
